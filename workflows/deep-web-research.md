...
```bash
/workflows:deep-web-research <query>
```
...
```bash
/workflows:deep-web-research latest developments in CRISPR gene editing techniques
/workflows:deep-web-research transformers vs RNNs for protein sequence analysis
/workflows:deep-web-research bioinformatics tools for RNA-seq differential expression analysis
```
...
- Identify 8-12 high-quality sources across different types (academic papers, documentation, benchmarks, implementation guides)
...
Perfect for literature reviews, methodology research, and technology evaluations.
