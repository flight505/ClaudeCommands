...
```bash
/tools:open-research
/tools:open-research <slug or topic>
```
...
7) If no matches are found, inform the user and suggest running `/workflows:deep-web-research <query>` first.

## Examples

```bash
# Open most recent research
/tools:open-research

# Open most recent research on CRISPR
/tools:open-research CRISPR

# Open most recent transformer research
/tools:open-research transformers
```
